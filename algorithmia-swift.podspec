#
#  Be sure to run `pod spec lint algorithmia-swift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = 'This library provides API access to Algorithmia in your iOS app'

  s.homepage     = "http://www.algorithmia.com/"
  ...
  s.source       = { :git => "https://github.com/algorithmiaio/algorithmia-swift.git", :tag => "#{s.version}" }
